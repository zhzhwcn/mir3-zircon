        ...
        public void DrawFloor()
        {
            ...
            for (int y = minY; y <= maxY; y++)
            {
                ...
                for (int x = minX; x <= maxX; x++)
                {
                    ...
                    if (Libraries.Mir2Order.TryGetValue(cell.MiddleFile, out file) && file != LibraryFile.Tilesc && Manager.LibraryList.TryGetValue(file, out library))
                    {
                    ...
                    if (Libraries.Mir2Order.TryGetValue(cell.FrontFile, out file) && file != LibraryFile.Tilesc && Manager.LibraryList.TryGetValue(file, out library))
                    {
